...
dirNum = 22
# fileNumber 文件的序号
for fileNumber in range(22, dirNum+1):
    # projectPath = "/Users/apple/PycharmProjects/paper2020_fingerprint/"
    projectPath = "/Volumes/Transcend/Rolled_Fingerprint_paper_2020/paper2020_fingerprint_code/"
    ...
    imwrite(projectPath + 'FAPImages/test111/' + str(fileNumber) + '_0' + '.bmp', img0)
    ...
    imwrite(projectPath + 'FAPImages/test111/' + str(fileNumber) + '_1' + '.bmp', tempImg)
